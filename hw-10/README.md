...
**Назначение.** Ответы клиентам TechnoMart (**РФ**) по статусу заказа, возврату и обмену, гарантии, наличию, доставке и типовым вопросам из базы знаний. Путь запроса: **мессенджер → шлюз API → поиск по базе → языковая модель**. Основной язык - **русский**. Модель работает как **ассистент** и не является единственным основанием для финансовых или юридических решений компании.
...
Персональные данные **маскируются** до передачи в модель. Разделение контрольного набора **70/15/15** - по категории обращения и региону склада.
...
flowchart TB
    ...
    TTL -->|Горячее 30 д| HOT[Дорогой тир<br/>S3 Standard]
    TTL -->|Тёплое 31-180 д| WARM[Редкий доступ<br/>S3 IA]
    TTL -->|Холодное / высокий риск 3 г| COLD[Архив<br/>S3 Glacier]
