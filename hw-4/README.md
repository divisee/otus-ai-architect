...
|---|---|---|
| 1 | Спецификации API Jivo / GreenAPI | Закладываем **изолирующий слой-адаптер** (канальные адаптеры): единый внутренний формат, уточнение спеки = доработка адаптера, не ядра. Нужны доступы к sandbox обоих API |
