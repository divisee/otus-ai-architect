...
- [12. Мониторинг после выката](#мониторинг-после-выката)
...
| 23 | CI/CD и выкатка в прод | [Развёртывание](#развёртывание) |
| 24 | мониторинг прода | [Мониторинг после выката](#мониторинг-после-выката) |
