...
| -------- | ----------- | ----- | --- |
| `Knowledge` | `graph_search`, `vector_search` | только чтение; выдача проходит через Policy до модели | [app/agents/knowledge.py](backend/app/agents/knowledge.py) |
