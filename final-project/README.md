...
| 10 | запись ребёнка с подтверждением | [Sequence](#sequence) |
| 11–12 | онтология и ER | [Онтология и ER](#онтология-и-er) |
| 13 | расчёт нагрузки и выбор видеокарт | [Типовой день и пик](#типовой-день-и-пик), [ADR-0004](docs/adr/0004-gpu-budget.md) |
| 14 | MVP: что проверено на стенде и что будет в промышленном контуре | [Порты стенда](#порты-стенда), [Локальный прогон](#локальный-прогон) |
| 15 | сборка, поставка и обновление контура | [Развёртывание](#развёртывание) |
| 16 | мониторинг промышленного контура | [Мониторинг промышленного контура](#мониторинг-промышленного-контура) |
| 17 | экономика: закупка, владение, цена сессии | [Капитальные затраты](#капитальные-затраты), [Стоимость сессии](#стоимость-сессии) |
| 18 | три контура метрик: онлайн, офлайн, правовой | [Метрики и проверка эффекта](#метрики-и-проверка-эффекта) |
| 19 | A/B против живой линии и цели первого года | [A/B против живой линии](#ab-против-живой-линии), [Цели первого года](#цели-первого-года) |
| 20 | результаты и выводы: что сделано, трудности, время, развитие | [Реестр требований](#реестр-требований), [Локальный прогон](#локальный-прогон), [Планы развития](#планы-развития) |
| 21–22 | итог и контакты | весь документ |
