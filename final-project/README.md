...
Дата: **2026-09-20**. Хост: MacBook Pro, Apple M5 Pro, 48 ГБ, macOS 26.6; `uvicorn` на `127.0.0.1:8080`. GPU и vLLM не запускались. Генератор — grounded, граф — Cypher-seed в памяти, индекс — BM25. Автотесты: **28 passed**.
