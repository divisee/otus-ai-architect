...
**Маршрут выступления.** Регламент — десять минут, колода при этом остаётся полной: часть слайдов показывается только по вопросам. Звезда в правом верхнем углу отмечает слайд основного выступления. Отмечены четырнадцать: обложка, автор, цель и задачи, проблема и ценность (слайды 1–4); архитектура контура, управление диалогом и хранилища, мультиагентная система (6–8); матрица доступа (10); MVP против промышленного контура (16); стоимость владения и три контура метрик (19–20); результаты и выводы, итог и контакты (22–24). Клавиши `Shift` + `→` и `Shift` + `←` переходят между отмеченными слайдами, обычные стрелки — по всем подряд.
