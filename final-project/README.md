...
**Окупаемость.** Высвобождение линии возвращает **71%** годовой стоимости владения (2,7 из 3,78 млн ₽). Чистая экономия ФОТ за вычетом сопровождения — 2,2 млн ₽/год. Непокрытый остаток 1,1 млн ₽ — плата за то, что речь и карточки не покидают периметр: облачный ассистент дал бы 4–8 ₽ за сессию против 30, но не проходит по 152-ФЗ. Полная окупаемость наступает при доле без оператора около 56% вместо целевых 40%; такой цели на первый год не ставится.
