...
| ------ | ---- | ------------- |
| 1 | обложка | заголовок работы |
| 2 | ценность для клиники | [Экономия линии](#экономия-линии), [Цели первого года](#цели-первого-года) |
| 3 | содержание | [Содержание](#содержание) |
| 4 | цель и границы объёма | [Объём системы](#объём-системы) |
| 5–6 | четыре места контура, девять ADR | [Стек](#стек) |
| 7–9 | C4 L1, L2, L3 | [Схемы](#схемы) |
...
| 13–16 | правило Policy, три пациента, запись, отказ | [Доступ](#доступ), [Sequence](#sequence) |
| 17–20 | онтология, опора ответа, ER, потоки данных | [Онтология и ER](#онтология-и-ер), [Data Flow](#data-flow) |
| 21 | четыре зоны сети | [Deployment](#deployment) |
| 22 | ёмкость, TCO, локальный прогон | [Нагрузка и стоимость](#нагрузка-и-стоимость), [Локальный прогон](#локальный-прогон) |
