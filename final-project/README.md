...
| --------- | ---------------- | -------- | ------- |
| Исходящие вызовы за периметр | 0 | сетевая политика зон, метрики исходящих соединений | непрерывно |
...
| 13 | девять решений ADR | [Стек](#стек), [`docs/adr/`](docs/adr/README.md) |
| 14–15 | матрица доступа, запись с подтверждением | [Доступ](#доступ), [Sequence](#sequence) |
| 16–18 | онтология, ER, потоки данных | [Онтология и ER](#онтология-и-ер), [Data Flow](#data-flow) |
...
| 24–28 | три контура метрик, онлайн, офлайн, A/B, цели года | [Метрики и проверка эффекта](#метрики-и-проверка-эффекта) |
