...
Ограничение: на стенде без GPU A/B не проводится — там фиксируется контракт доступа.
...
Фаза GPU не блокирует проверку ACL и GraphRAG. Стенд: **25 тестов** (ACL, ReBAC, обязанности регистратуры, диагностика, HITL, обнаружение ПДн, оба канала, BM25).
...
| 31 | выводы о работе: цель, трудности, время, развитие | [Цель и задачи](#цель-и-задачи), [Планы развития](#планы-развития) |
| 32–33 | итог и контакты | весь документ |
