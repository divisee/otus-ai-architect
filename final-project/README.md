...
| 5 | цель и границы объёма | [Объём системы](#объём-системы) |
| 6–7 | четыре места контура, девять ADR | [Стек](#стек) |
...
| 14–17 | правило Policy, три пациента, запись, отказ | [Доступ](#доступ), [Sequence](#sequence) |
| 18–21 | онтология, опора ответа, ER, потоки данных | [Онтология и ER](#онтология-и-ер), [Data Flow](#data-flow) |
| 22 | четыре зоны сети | [Deployment](#deployment) |
| 23 | ёмкость, TCO, локальный прогон | [Нагрузка и стоимость](#нагрузка-и-стоимость), [Локальный прогон](#локальный-прогон) |
| 24–28 | контуры измерения, онлайн, офлайн, A/B, цели года | [Метрики и проверка эффекта](#метрики-и-проверка-эффекта) |
| 29–34 | выводы, итог, контакты | весь документ |
