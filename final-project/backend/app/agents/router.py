...
# Основы, а не словоформы: «запиШите» и «окнА» не содержат «запис» и «окно».
# BOOKING_CUES — подмножество, по которому узел CRM решает предлагать ли окна;
# держим его здесь в одном месте, чтобы маршрут и узел не разошлись.
